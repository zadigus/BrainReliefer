...
namespace N_Data
{
  class Data: public ::xml_schema::type
  {
    ...
    typedef ::xsd::cxx::tree::sequence< DataPath_type > DataPath_sequence;
    typedef DataPath_sequence::iterator DataPath_iterator;
    typedef DataPath_sequence::const_iterator DataPath_const_iterator;
    typedef ::xsd::cxx::tree::traits< DataPath_type, char > DataPath_traits;

    const DataPath_sequence&
    DataPath () const;
  ...
  class DataPath: public ::xml_schema::string
  {
    ...
    // Constructors.
    //
    DataPath (const name_type&);

    DataPath (const char*,
              const name_type&);

    DataPath (const ::std::string&,
              const name_type&);

    DataPath (const ::xml_schema::string&,
              const name_type&);
