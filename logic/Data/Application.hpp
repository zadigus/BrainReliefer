...
namespace N_ApplicationData
{
  class Application: public ::xml_schema::type
  {
    ...
    // Log
    //
    typedef ::N_ApplicationData::Log Log_type;
    ...
    // Settings
    //
    typedef ::N_ApplicationData::Settings Settings_type;
    ...
    // Constructors.
    //
    Application (const Log_type&,
                 const Settings_type&);

    Application (::std::unique_ptr< Log_type >,
                 ::std::unique_ptr< Settings_type >);
  ...
  class Log: public ::xml_schema::type
  {
    ...
    // Filename
    //
    typedef ::N_ApplicationData::Filename Filename_type;
    ...
    // Mode
    //
    typedef ::N_ApplicationData::Mode Mode_type;
...
namespace N_ApplicationData
{
  ...
  Application_ (const ::std::string& uri,
                ::xml_schema::flags f = 0,
  ...
  ::std::unique_ptr< ::N_ApplicationData::Application >
  Application_ (::xercesc::InputSource& is,
                ::xml_schema::flags f = 0,
                const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  ::std::unique_ptr< ::N_ApplicationData::Application >
  Application_ (const ::xercesc::DOMDocument& d,
                ::xml_schema::flags f = 0,
                const ::xml_schema::properties& p = ::xml_schema::properties ());
...
namespace N_ApplicationData
{
  ...
  void
  Application_ (::std::ostream& os,
                const ::N_ApplicationData::Application& x, 
  ...
  void
  Application_ (::xercesc::XMLFormatTarget& ft,
                const ::N_ApplicationData::Application& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                const ::std::string& e = "UTF-8",
                ::xml_schema::flags f = 0);
  ...
  Application_ (const ::N_ApplicationData::Application& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                ::xml_schema::flags f = 0);
