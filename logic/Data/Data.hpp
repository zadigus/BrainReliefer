...
namespace N_Data
{
  // RootDir (fixed-length)
  //
  class RootDir: public ::std::string
  {
    public:
    RootDir ();
  };

  // DataPath (fixed-length)
  //
  class DataPath: public ::std::string
  {
    public:
    DataPath ();
  ...
  class Data
  {
    ...
    // DataPath
    //
    typedef ::xsde::cxx::hybrid::fix_sequence< ::N_Data::DataPath > DataPath_sequence;
