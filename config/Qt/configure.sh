...
# This may work:
./configure --prefix="/home/mihl/Libraries/Qt/5.7/android_x86-debug-static" -static -debug -xplatform android-g++ -android-arch x86_64 -android-sdk /home/mihl/Libraries/android-sdk -android-ndk /home/mihl/Libraries/android-sdk/ndk-bundle -skip qttranslations -skip qtserialport -qml-debug -largefile -developer-build -optimized-tools -opensource -confirm-license -no-compile-examples -nomake examples -nomake tests -opengl -fontconfig -pkg-config -android-ndk-platform android-24
